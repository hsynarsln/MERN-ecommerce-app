...
export const profileReducer = (state = initialState.profile, { type, payload }) => {
  switch (type) {
...
export const forgotPasswordReducer = (state = initialState.password, { type, payload }) => {
  switch (type) {
...
export const allUserReducer = (state = initialState.users, { type, payload }) => {
  switch (type) {
...
export const userDetailsReducer = (state = initialState.userDetail, { type, payload }) => {
  switch (type) {
